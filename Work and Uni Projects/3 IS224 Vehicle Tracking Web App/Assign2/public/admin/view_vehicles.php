...
<?php
    ...
    if (!empty($vehicle_set))
    {
        ...
        while ($vehicle = mysqli_fetch_assoc($vehicle_set))
        {
            ...
            $report .= "<td style=\"text-align: center;\"> ";
            $report .= "<a href=\"form_edit_vehicle.php?vn=" . urlencode($vehicle["veh_num"]) . "\">Edit Vehicle</a>";
            $report .= "</td>";

            $report .= "<td style=\"text-align: center;\"> ";
            $report .= "<a href=\"delete_vehicle.php?veh_num=" . urlencode($vehicle["veh_num"]) . "\">Delete Vehicle</a>";
            $report .= "</td>";
