...
<?php
    ...
    if (!empty($signout_set))
    {
        ...
        $report .= "<thead>";
        $report .= "<th style=\"text-align: center;\"> Sign Out Number </th>";
		...
		$report .= "<th style=\"text-align: center;\"> Sign Out Date </th>";
		$report .= "<th style=\"text-align: center;\"> Sign Out Units </th>";
        $report .= "</thead>";
